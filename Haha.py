...
def ressture():
   ...
   import getpass
   sandi = raw_input('║PW      : ')
   if sandi == 'aryaeka' and user == 'aryaeka':
      print '║LOGIN SUKSES\n╚═══════\x1b[1;91m▶'
      sys.exit
   else:
...
def lodhirt():
    lodhirt = [
     'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya', '      ', 'Arya\n']
    for o in lodhirt:
